<template>
  <!-- <p class="join-form__block">
    ...
    <ul v-if="countries.length">
      <li v-for="country in countries" @click="search"> {{country.name}} </li>
    </ul>
  </p> -->
  <p class="search-form__block">
    ...
    <span class="search-form__result">
      <!-- <span class="search-form__result" v-if="countries.length"> -->
      <ul class="search-form__result-list">
        <!-- <li class="search-form__result-item" v-for="country in countries" @click="search" :key="country"> {{country.name}} </li> -->
        <li class="search-form__result-item">Belarus</li>
        <li class="search-form__result-item">Russia</li>
        <li class="search-form__result-item">USA</li>
        <li class="search-form__result-item">Germany</li>
        <li class="search-form__result-item">Poland</li>
        <li class="search-form__result-item">Other country</li>
        <li class="search-form__result-item">Country</li>
      </ul>
    </span>
    <!-- </span> -->
  </p>
